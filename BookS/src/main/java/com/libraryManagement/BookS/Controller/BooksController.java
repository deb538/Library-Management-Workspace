...
public class BooksController {
	...
	@PutMapping("link/Book/{bookSerialNumber}/Student/{studentId}")
	public ResponseEntity<String> linkBookWithStudent(@PathVariable("bookSerialNumber") String bookSerialNumber, @PathVariable Integer studentId) {
